                  ...
                  <form id="create_form">
                      ...
                      <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="number_room" class="form-control" id="number_room"
                                    placeholder="ادخل رقم الغرفة ">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="Advantages"> المزايا</label>
                                <input type="text" name="Advantages" class="form-control" id="Advantages"
                      ...
                      <div class="card-footer">
                         ...
                         <a href="{{route('rooms.index')}}"><button type="button" class="btn btn-lg btn-danger"> قائمة غرف </button></a>
                      </div>
                  </form>
              </div>
              <!-- /.card -->
