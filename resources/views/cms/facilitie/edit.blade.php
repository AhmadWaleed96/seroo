              ...
              <div class="card card-danger">
                  ...
                  <form id="create_form">
                      ...
                      <div class="card-footer">
                          <button type="button" onclick="update({{ $facilities->id }})" class="btn btn-lg btn-warning">حفظ</button>
                         <a href="{{route('indexFacilitie',$id)}}"><button type="button" class="btn btn-lg btn-danger"> قائمة المرافق</button></a>
                      </div>
                  </form>
              </div>
              <!-- /.card -->
